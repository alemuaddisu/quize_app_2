...
//            if (!prefManager?.isFirstTimeLaunch()!!) {
    ...
    fun addQuestionsToDB(){
        val quiz1 = Quiz(1,"1) Android is","A. an operating system", "B. a web browser","C. a web server","D. None of the above","a","Answer: (a) an operating system\n" +
                "\n" +
                "Android is a software package and linux based operating system for mobile devices such as tablet computers and smartphones.")
        val quiz2 = Quiz(2,"2) Under which of the following Android is licensed?", "A. OSS","B. Sourceforge","C. Apache/MIT","D. None of the above","c","Answer: (c) Apache/MIT\n" +
                "\n" +
        ...
        val quiz3 = Quiz(3,"3) For which of the following Android is mainly developed?","A. Servers", "B. Desktops","C. Laptops","D. Mobile devices","d","Answer: (d) Mobile devices\n" +
                "\n" +
        ...
        val quiz4 = Quiz(4,"4) Which of the following is the first mobile phone released that ran the Android OS?","A. HTC Hero", "B. Google gPhone","C. T - Mobile G1","D. None of the above","c","Answer: (c) T - Mobile G1\n" +
                "\n" +
        ...
        val quiz5 = Quiz(5,"5) Which of the following virtual machine is used by the Android operating system?","A. JVM", "B. Dalvik virtual machine","C. Simple virtual machine","D. None of the above","b","Answer: (b) Dalvik virtual machine\n" +
                "\n" +
        ...
        val quiz6 = Quiz(6,"6) Android is based on which of the following language?","A. Java", "B. C++","C. C","D. None of the above","a","Answer: (a) Java\n" +
                "\n" +
                "Explanation: Java language is mainly used to write the android code even though other languages can be used.")
        val quiz7 = Quiz(7,"7) APK stands for -","A. Android Phone Kit", "B. Android Page Kit","C. Android Package Kit","D. None of the above","c","Answer: (c) Android Package Kit\n" +
                "\n" +
        ...
        val quiz8 = Quiz(8,"8) What does API stand for?","A. Application Programming Interface", "B. Android Programming Interface","C. Android Page Interface","D. Application Page Interface","a","Answer: (a) Application Programming Interface\n" +
                "\n" +
        ...
        val quiz9 = Quiz(9,"9) Which of the following converts Java byte code into Dalvik byte code?","A. Dalvik converter", "B. Dex compiler","C. Mobile interpretive compiler (MIC)","D. None of the above","b","Answer: (b) Dex compiler\n" +
                "\n" +
        ...
        val quiz10 = Quiz(10,"10) How can we stop the services in android?","A. By using the stopSelf() and stopService() method", "B. By using the finish() method","C. By using system.exit() method","D. None of the above","a","Answer: (a) By using the stopSelf() and stopService() method\n" +
                "\n" +
        ...
        val quiz11 = Quiz(11,"11) What is an activity in android?","A. android class", "B. android package","C. A single screen in an application with supporting java code","D. None of the above","c","Answer: (c) A single screen in an application with supporting java code\n" +
                "\n" +
        ...
        val quiz12 = Quiz(12,"12) How can we kill an activity in android?","A. Using finish() method", "B. Using finishActivity(int requestCode)","C. Both (a) and (b)","D. Neither (a) nor (b)","c","Answer: (c) Both (a) and (b)\n" +
                "\n" +
        ...
        val quiz13 = Quiz(13,"13) ADB stands for -","A. Android debug bridge", "B. Android delete bridge","C. Android destroy bridge","D. None of the above","a","Answer: (a) Android debug bridge\n" +
                "\n" +
        ...
        val quiz14 = Quiz(14,"14) On which of the following, developers can test the application, during developing the android applications?",
        ...
        val quiz15 = Quiz(15,"15) Which of the following kernel is used in Android?","A. MAC", "B. Windows","C. Linux","D. Redhat","c","Answer: (c) Linux\n" +
                "\n" +
